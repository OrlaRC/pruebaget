...
const InicioSesion = () => {
  ...
  const handleLogin = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch('http://localhost:3000/ https://financiera-backend.vercel.app/api/auth/login', {
        method: 'POST',
      ...
      <div className="desktop3-desktop">
        ...
        <form className="desktop3-form-contact" onSubmit={handleLogin}>
          ...
          <button
            ...
            type="button"
            onClick={() => window.location.href = 'http://localhost:3000/ https://financiera-backend.vercel.app/api/auth/google'}
          >
            <img
